...
public class OlingoSampleApp {
    ...
    public static void main(String[] params) throws Exception {
        ...
        app.perform("https://services.odata.org/v2/northwind/northwind.svc");
    }
    ...
    void perform(String serviceUrl) throws Exception {
        ...
        ClientEntitySetIterator<ClientEntitySet, ClientEntity> iterator =
                readEntities(edm, serviceUrl, "Regions");
        ...
        print("\n----- Read Entry ------------------------------");
        ClientEntity entry = readEntityWithKey(edm, serviceUrl, "Regions", 1);
