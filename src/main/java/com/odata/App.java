...
public class App {
    ...
    public static void main(String[] args) throws ODataException, IOException {
        App app = new App();
        String serviceUrl = "https://services.odata.org/v2/northwind/northwind.svc";
        ...
        print("\n----- Read Feed ------------------------------");
        Regions regions = new Regions(app.readFeed(edm, serviceUrl, usedFormat, "Regions").getEntries());
        Territories territories = new Territories(app.readFeed(edm, serviceUrl, usedFormat, "Territories").getEntries());

        for (Region region : regions.getItem()) {
            region.setTerritories(territories);
        }

        System.out.println(regions.getItem().toString());
        System.out.println(territories.getItem().toString());
...
//            print("##########");
//            //print("Entry:\n" + prettyPrint(entry));
//            //print(entry.getProperties().keySet().toString());
//
//            print("##########");
//        }
